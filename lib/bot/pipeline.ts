...
// ─── Style Prompts (same as generate-image route) ─────────────────────
...
const STYLE_PROMPTS: Record<string, string> = {
  ...
  surreal: `Create a surrealist illustration in the style of Salvador Dali, with dreamlike impossible imagery, melting objects, unexpected juxtapositions, symbolic elements, and the bizarre beauty of the subconscious mind.`,
