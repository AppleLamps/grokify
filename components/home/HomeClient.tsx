...
export default function Home() {
  ...
  return (
    <SidebarProvider defaultOpen={false}>
      ...
      <main className="relative z-10 min-h-screen w-full flex-1 px-4 sm:px-6 lg:px-12 py-10 sm:py-16 lg:py-24 flex flex-col justify-start lg:justify-center">
        <div className="max-w-6xl mx-auto w-full space-y-16 lg:space-y-24">
